...
public class RecyclerCervejaAdapter extends RecyclerView.Adapter<RecyclerCervejaAdapter.MyViewHolder> {

    Context mContext;
    List<Cerveja> mData;

    public RecyclerCervejaAdapter(Context mContext, List<Cerveja> mData) {
