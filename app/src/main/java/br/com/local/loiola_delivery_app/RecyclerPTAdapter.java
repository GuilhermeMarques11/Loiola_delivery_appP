...
public class RecyclerPTAdapter extends RecyclerView.Adapter<RecyclerPTAdapter.MyViewHolder> {

    Context mContext;
    List<PizzasTradicionais> mData;

    public RecyclerPTAdapter(Context mContext, List<PizzasTradicionais> mData) {
