...
public class RecyclerRefriAdapter extends RecyclerView.Adapter<RecyclerRefriAdapter.MyViewHolder> {


    Context mContext;
    List<Refrigerantes> mData;

    public RecyclerRefriAdapter(Context mContext, List<Refrigerantes> mData) {
